...
import (
	...
	"github.com/Augustu/go-micro/v2/api/resolver"
	"github.com/Augustu/go-micro/v2/api/resolver/vpath"
	"github.com/Augustu/go-micro/v2/api/router"
	regRouter "github.com/Augustu/go-micro/v2/api/router/registry"
