...
import (
	...
	"github.com/Augustu/go-micro/v2/auth/provider"
	"github.com/Augustu/go-micro/v2/broker"
	"github.com/Augustu/go-micro/v2/client"
	"github.com/Augustu/go-micro/v2/client/grpc"
	"github.com/Augustu/go-micro/v2/client/selector"
	"github.com/Augustu/go-micro/v2/config"
	configSrc "github.com/Augustu/go-micro/v2/config/source"
	configSrv "github.com/Augustu/go-micro/v2/config/source/service"
	"github.com/Augustu/go-micro/v2/debug/profile"
	"github.com/Augustu/go-micro/v2/debug/profile/http"
	"github.com/Augustu/go-micro/v2/debug/profile/pprof"
	"github.com/Augustu/go-micro/v2/debug/trace"
	"github.com/Augustu/go-micro/v2/logger"
	"github.com/Augustu/go-micro/v2/registry"
	registrySrv "github.com/Augustu/go-micro/v2/registry/service"
	...
	authutil "github.com/Augustu/go-micro/v2/util/auth"
	"github.com/Augustu/go-micro/v2/util/wrapper"

	// clients
	cgrpc "github.com/Augustu/go-micro/v2/client/grpc"
	cmucp "github.com/Augustu/go-micro/v2/client/mucp"

	// servers
	"github.com/micro/cli/v2"

	sgrpc "github.com/Augustu/go-micro/v2/server/grpc"
	smucp "github.com/Augustu/go-micro/v2/server/mucp"

	// brokers
	brokerHttp "github.com/Augustu/go-micro/v2/broker/http"
	"github.com/Augustu/go-micro/v2/broker/memory"
	"github.com/Augustu/go-micro/v2/broker/nats"
	brokerSrv "github.com/Augustu/go-micro/v2/broker/service"

	// registries
	"github.com/Augustu/go-micro/v2/registry/etcd"
	"github.com/Augustu/go-micro/v2/registry/mdns"
	rmem "github.com/Augustu/go-micro/v2/registry/memory"
	regSrv "github.com/Augustu/go-micro/v2/registry/service"

	// runtimes
	kRuntime "github.com/Augustu/go-micro/v2/runtime/kubernetes"
	lRuntime "github.com/Augustu/go-micro/v2/runtime/local"
	srvRuntime "github.com/Augustu/go-micro/v2/runtime/service"

	// selectors
	"github.com/Augustu/go-micro/v2/client/selector/dns"
	"github.com/Augustu/go-micro/v2/client/selector/router"
	"github.com/Augustu/go-micro/v2/client/selector/static"

	// transports
	thttp "github.com/Augustu/go-micro/v2/transport/http"
	tmem "github.com/Augustu/go-micro/v2/transport/memory"

	// stores
	memStore "github.com/Augustu/go-micro/v2/store/memory"
	svcStore "github.com/Augustu/go-micro/v2/store/service"

	// tracers
	// jTracer "github.com/Augustu/go-micro/v2/debug/trace/jaeger"
	memTracer "github.com/Augustu/go-micro/v2/debug/trace/memory"

	// auth
	jwtAuth "github.com/Augustu/go-micro/v2/auth/jwt"
	svcAuth "github.com/Augustu/go-micro/v2/auth/service"

	// auth providers
	"github.com/Augustu/go-micro/v2/auth/provider/basic"
	"github.com/Augustu/go-micro/v2/auth/provider/oauth"
)
