// Package kubernetes taken from https://github.com/Augustu/go-micro/blob/master/debug/log/kubernetes/kubernetes.go
...
import (
	...
	"github.com/Augustu/go-micro/v2/util/kubernetes/client"
	"github.com/Augustu/go-micro/v2/util/log"
)
